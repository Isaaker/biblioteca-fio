...
const FIO_DICT = {
  es: {
    ...
    footer_collaborate: 'Colaborar',
    footer_thanks: 'Gracias',
    thanks_sponsors_title: 'Patrocinadores',
    thanks_sponsors_lead: 'Empresas e instituciones que hacen posible la labor de la Fundación.',
    thanks_partners_title: 'Entidades colaboradoras',
    collab_title: 'Colaborar — Biblioteca FIO',
    collab_heading: 'Colabora con la biblioteca',
    collab_lead: 'La biblioteca funciona gracias a personas que donan, apoyan y dedican su tiempo. Estas son las formas de sumarte.',
    collab_donate_title: 'Dona libros',
    collab_donate_text: '¿Tienes libros, revistas o documentos de aviación que quieras que se conserven y se compartan? Cuéntanos qué tienes y cómo entregarlo.',
    collab_donate_cta: 'Quiero donar un volumen',
    collab_member_title: 'Hazte socio',
    collab_member_text: 'Las cuotas de socios sostienen la conservación del patrimonio aeronáutico.',
    collab_volunteer_title: 'Sé voluntario',
    collab_volunteer_text: 'Colabora en las tareas necesarias para mantener la fundación en funcionamiento. No hace falta experiencia previa: te acompañamos.',
    collab_company_title: 'Empresas e instituciones',
    collab_company_text: 'Si tu organización quiere patrocinar o colaborar, escríbenos y hablamos.',
    collab_see_thanks: 'Ver a quienes ya colaboran',
    ...
    form_member_label: 'Número de socio (opcional)',
    form_error_name: 'Indica tu nombre.',
    form_error_email: 'Indica tu correo electrónico.',
    form_error_email_invalid: 'El correo electrónico no parece válido. Revísalo, por favor.',
  ...
  en: {
    ...
    footer_collaborate: 'Get involved',
    footer_thanks: 'Thanks',
    thanks_sponsors_title: 'Sponsors',
    thanks_sponsors_lead: 'Companies and institutions that make the Foundation\'s work possible.',
    thanks_partners_title: 'Partner organisations',
    collab_title: 'Get involved — FIO Library',
    collab_heading: 'Help the library',
    collab_lead: 'The library runs thanks to people who donate, support and give their time. Here is how you can join in.',
    collab_donate_title: 'Donate books',
    collab_donate_text: 'Do you have aviation books, magazines or documents you would like preserved and shared? Tell us what you have and how to deliver it.',
    collab_donate_cta: 'I want to donate a volume',
    collab_member_title: 'Become a member',
    collab_member_text: 'Membership fees sustain the preservation of aeronautical heritage.',
    collab_volunteer_title: 'Volunteer',
    collab_volunteer_text: 'Help with the tasks needed to keep the foundation running. No previous experience is required: we will guide you.',
    collab_company_title: 'Companies and institutions',
    collab_company_text: 'If your organisation wants to sponsor or collaborate, write to us and we will talk.',
    collab_see_thanks: 'See who already collaborates',
    ...
    form_member_label: 'Member number (optional)',
    form_error_name: 'Please enter your name.',
    form_error_email: 'Please enter your email address.',
    form_error_email_invalid: 'The email address does not look valid. Please check it.',
